...
using Soenneker.Blazor.Auth.EntraRolesPrincipalFactory.Registrars;
using Soenneker.Serilog.Sinks.Browser.Blazor.Registrars;

namespace Soenneker.Blazor.Auth.EntraRolesPrincipalFactory.Demo;
...
public class Program
{
    public static async Task Main(string[] args)
    {
        try
        {
            ...
            builder.Services.AddEntraRolesPrincipalFactoryAsScoped();
